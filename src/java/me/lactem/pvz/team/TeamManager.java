...
public class TeamManager {
	...
	public void addToPlants(Player player, Game game, PlantType type, boolean message) {
		...
		if (message)
			api.getMessageUtil().sendMessage(player, api.getMessageUtil().getMessage("joined plant team"));
	...
	public void addToZombies(Player player, Game game, ZombieType type, boolean message) {
		...
		if (message)
			api.getMessageUtil().sendMessage(player, api.getMessageUtil().getMessage("joined zombie team"));
